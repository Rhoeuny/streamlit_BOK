...
neg_dic = pd.read_csv("data/total_dov_dic.csv")
pos_dic = pd.read_csv("data/total_haw_dic.csv")
pos_dic = pos_dic.rename(columns={'Unnamed: 0': 'H_Key'})
neg_dic = neg_dic.rename(columns={'Unnamed: 0': 'D_Key'})

neg_sent = pd.read_csv("data/do_ngram_minsent.csv")
pos_sent = pd.read_csv("data/hw_ngram_minsent.csv")
